...
async function main() {
        ...
        for (const lookbackPeriod of lookbacks) {
          ...
          for (let i = 1; i < ohlcv.length; i++) {
            ...
            if (
              ...
              if (
                priceDelta > priceChangeThreshold &&
              ...
              if (
                ...
                if (
                  ...
                  logger.info(
                    `[Exit] Exit trade at ${curr.timestamp} price=${curr.close} PnL=${lastTrade.pnl}`,
                  );
                  lastTrade = null;
                }
              }
  ...
  logger.info(
    `[BacktestSummary] {"totalPnl":${totalPnl},"wins":${wins},"losses":${losses},"avgPnl":${avgPnl}}`,
  );
}
