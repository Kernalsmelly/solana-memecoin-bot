 ...
 */
export function wireFastTradeExecution(patternDetector, txnBuilder, signers) {
    patternDetector.on('patternMatch', async (match) => {
        try {
            ...
            logger.info(`[FastTradeExecutor] Executing ${type} template for pool ${poolKey} (amount: ${amount}, fee: ${fee})`);
...
//# sourceMappingURL=fastTradeExecutor.js.map