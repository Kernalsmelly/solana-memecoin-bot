...
export function parseJupiterQuote(response) {
    if (!response || !response.outAmount)
...
export async function fetchJupiterQuote({ inputMint, outputMint, amount, slippageBps, }) {
