...
function createLineChart(data, title, width = 50, height = 10) {
    if (data.length === 0)
        return 'No data available';
...
function renderDashboard(metrics) {
    ...
    const patternPerformance = createBarChart([187.5, 75.9, 66.8, 61.0, 55.3], ['Mega Pump', 'Vol Squeeze', 'Smart Trap', 'Stop Hunt', 'Reversal'], 'Pattern Returns (%)');
