...
export type PatternType = 'Mega Pump and Dump' | 'Volatility Squeeze' | 'Smart Money Trap' | 'Algorithmic Stop Hunt' | 'Smart Money Reversal' | 'Volume Divergence' | 'Hidden Accumulation' | 'Wyckoff Spring' | 'Liquidity Grab' | 'FOMO Cycle';
