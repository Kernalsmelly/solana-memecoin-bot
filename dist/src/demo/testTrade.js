...
const tradeSimulator_1 = require("../tradeSimulator");
async function runRobustTest() {
    ...
    const scenarios = [
        {
            ...
            patterns: [
                ...
                { name: 'Spring Formation', price: 0.80, volume: 180, momentum: -5, volumeTrend: 80 },
                { name: 'Test', price: 0.95, volume: 80, momentum: 25, volumeTrend: -20 },
                { name: 'Sign of Strength', price: 1.20, volume: 120, momentum: 40, volumeTrend: 20 },
                { name: 'Backup', price: 1.10, volume: 60, momentum: -10, volumeTrend: -40 },
                { name: 'Markup', price: 1.50, volume: 200, momentum: 45, volumeTrend: 100 }
            ]
        },
        {
            name: 'Distribution Phase',
            patterns: [
                { name: 'Preliminary Supply', price: 1.20, volume: 120, momentum: 30, volumeTrend: 20 },
                { name: 'Buying Climax', price: 1.50, volume: 180, momentum: 40, volumeTrend: 80 },
                ...
                { name: 'Markdown', price: 0.90, volume: 200, momentum: -40, volumeTrend: 100 }
            ]
        },
        {
            name: 'Bull Trap',
            patterns: [
                { name: 'Initial Rally', price: 1.30, volume: 150, momentum: 35, volumeTrend: 50 },
                { name: 'FOMO Peak', price: 1.50, volume: 200, momentum: 45, volumeTrend: 100 },
                { name: 'Sharp Decline', price: 1.20, volume: 180, momentum: -30, volumeTrend: 80 },
                { name: 'Bull Trap Rally', price: 1.35, volume: 120, momentum: 15, volumeTrend: 20 },
                { name: 'Capitulation', price: 0.80, volume: 250, momentum: -50, volumeTrend: 150 }
            ]
        },
        {
            name: 'Extreme Volatility',
            patterns: [
                { name: 'Initial Surge', price: 1.50, volume: 300, momentum: 60, volumeTrend: 150 },
                { name: 'First Shakeout', price: 1.20, volume: 400, momentum: -40, volumeTrend: 200 },
                { name: 'V-Shaped Recovery', price: 1.80, volume: 500, momentum: 70, volumeTrend: 250 },
                { name: 'Sharp Rejection', price: 1.40, volume: 600, momentum: -50, volumeTrend: 300 },
                { name: 'Final Surge', price: 2.00, volume: 700, momentum: 80, volumeTrend: 350 },
                { name: 'Collapse', price: 1.00, volume: 800, momentum: -70, volumeTrend: 400 }
            ]
        },
        {
            name: 'Low Liquidity Pump',
            patterns: [
                { name: 'Stealth Phase', price: 1.20, volume: 50, momentum: 20, volumeTrend: -50 },
                { name: 'Initial Pump', price: 2.00, volume: 30, momentum: 90, volumeTrend: -70 },
                { name: 'Volume Spike', price: 3.00, volume: 400, momentum: 95, volumeTrend: 200 },
                { name: 'Quick Drop', price: 2.50, volume: 300, momentum: -60, volumeTrend: 150 },
                { name: 'Dead Cat', price: 2.80, volume: 100, momentum: 30, volumeTrend: -30 },
                { name: 'Liquidity Crisis', price: 1.50, volume: 20, momentum: -80, volumeTrend: -90 }
            ]
        },
        {
            name: 'Flash Crash',
            patterns: [
                { name: 'Pre-Crash High', price: 2.00, volume: 200, momentum: 40, volumeTrend: 50 },
                { name: 'Initial Break', price: 1.80, volume: 400, momentum: -30, volumeTrend: 100 },
                { name: 'Cascade Start', price: 1.50, volume: 600, momentum: -50, volumeTrend: 200 },
                { name: 'Liquidation', price: 1.00, volume: 1000, momentum: -90, volumeTrend: 400 },
                { name: 'Bounce Attempt', price: 1.20, volume: 800, momentum: 20, volumeTrend: 300 },
                { name: 'Secondary Drop', price: 0.80, volume: 500, momentum: -60, volumeTrend: 150 }
            ]
        },
        {
            name: 'Wyckoff Spring',
            patterns: [
                { name: 'PS', price: 0.90, volume: 120, momentum: -20, volumeTrend: 20 },
                ...
                { name: 'Phase B', price: 1.20, volume: 180, momentum: 40, volumeTrend: 80 },
                { name: 'Phase C', price: 1.50, volume: 250, momentum: 45, volumeTrend: 150 },
                { name: 'Phase D', price: 2.00, volume: 300, momentum: 50, volumeTrend: 200 }
            ]
        },
        {
            name: 'Cascading Liquidation',
            patterns: [
                { price: 2.000, volume: 200, momentum: 40, volumeTrend: 50 },
                { price: 1.800, volume: 400, momentum: -20, volumeTrend: 150 },
                { price: 1.600, volume: 800, momentum: -40, volumeTrend: 250 },
                { price: 1.200, volume: 1200, momentum: -60, volumeTrend: 400 },
                { price: 1.000, volume: 2000, momentum: -80, volumeTrend: 600 },
                { price: 0.800, volume: 3000, momentum: -90, volumeTrend: 800 }
            ]
        },
        {
            name: 'Volatility Squeeze',
            patterns: [
                { price: 1.000, volume: 100, momentum: 10, volumeTrend: -50 },
                { price: 1.050, volume: 50, momentum: 5, volumeTrend: -70 },
                { price: 1.020, volume: 20, momentum: -5, volumeTrend: -90 },
                { price: 1.500, volume: 2000, momentum: 80, volumeTrend: 500 },
                { price: 1.200, volume: 1500, momentum: -40, volumeTrend: 400 },
                { price: 1.100, volume: 1000, momentum: -20, volumeTrend: 300 }
            ]
        },
        {
            name: 'Multi-Wave Bull Trap',
            patterns: [
                { price: 1.200, volume: 200, momentum: 30, volumeTrend: 50 },
                { price: 1.500, volume: 400, momentum: 50, volumeTrend: 100 },
                { price: 1.300, volume: 300, momentum: -20, volumeTrend: 80 },
                { price: 1.600, volume: 500, momentum: 60, volumeTrend: 150 },
                { price: 1.400, volume: 400, momentum: -30, volumeTrend: 120 },
                { price: 1.800, volume: 600, momentum: 70, volumeTrend: 200 },
                { price: 1.000, volume: 1000, momentum: -80, volumeTrend: 400 }
            ]
        },
        {
            name: 'Low Volume Manipulation',
            patterns: [
                { price: 1.000, volume: 100, momentum: 10, volumeTrend: -40 },
                { price: 1.200, volume: 50, momentum: 30, volumeTrend: -60 },
                { price: 1.500, volume: 20, momentum: 50, volumeTrend: -80 },
                { price: 1.400, volume: 30, momentum: -20, volumeTrend: -70 },
                { price: 1.600, volume: 10, momentum: 40, volumeTrend: -90 },
                { price: 1.100, volume: 500, momentum: -60, volumeTrend: 200 }
            ]
        },
        {
            name: 'Momentum Divergence',
            patterns: [
                { price: 1.000, volume: 200, momentum: 40, volumeTrend: 100 },
                { price: 1.200, volume: 300, momentum: 50, volumeTrend: 150 },
                { price: 1.400, volume: 200, momentum: 45, volumeTrend: 120 },
                { price: 1.600, volume: 150, momentum: 40, volumeTrend: 80 },
                { price: 1.800, volume: 100, momentum: 30, volumeTrend: 40 },
                { price: 1.300, volume: 400, momentum: -50, volumeTrend: 200 }
            ]
        },
        {
            name: 'Whale Distribution Game',
            patterns: [
                { price: 1.000, volume: 200, momentum: 20, volumeTrend: 50 }, // Base accumulation
                { price: 1.200, volume: 500, momentum: 40, volumeTrend: 150 }, // First push
                { price: 1.150, volume: 300, momentum: -10, volumeTrend: 80 }, // Mini dip
                { price: 1.400, volume: 800, momentum: 60, volumeTrend: 250 }, // FOMO push
                { price: 1.350, volume: 400, momentum: -20, volumeTrend: 100 }, // First distribution
                { price: 1.500, volume: 1000, momentum: 70, volumeTrend: 300 }, // Peak push
                { price: 1.450, volume: 600, momentum: -15, volumeTrend: 150 }, // Second distribution
                { price: 1.600, volume: 1200, momentum: 80, volumeTrend: 400 }, // Final push
                { price: 1.000, volume: 2000, momentum: -90, volumeTrend: 800 } // Whale dump
            ]
        },
        {
            name: 'Low Float Squeeze',
            patterns: [
                { price: 1.000, volume: 100, momentum: 10, volumeTrend: -60 }, // Base
                { price: 1.050, volume: 50, momentum: 5, volumeTrend: -80 }, // Volume dry up
                { price: 1.030, volume: 20, momentum: -5, volumeTrend: -90 }, // Tight range
                { price: 1.100, volume: 10, momentum: 10, volumeTrend: -95 }, // Final squeeze
                { price: 1.500, volume: 1000, momentum: 90, volumeTrend: 300 }, // Breakout
                { price: 2.000, volume: 2000, momentum: 95, volumeTrend: 500 }, // Parabolic
                { price: 2.500, volume: 3000, momentum: 98, volumeTrend: 800 }, // Climax
                { price: 1.800, volume: 4000, momentum: -70, volumeTrend: 1000 } // Blow-off top
            ]
        },
        {
            name: 'Smart Money Trap',
            patterns: [
                { price: 1.000, volume: 300, momentum: 30, volumeTrend: 100 }, // Strong base
                { price: 0.800, volume: 1000, momentum: -50, volumeTrend: 300 }, // Stop hunt
                { price: 0.900, volume: 500, momentum: 20, volumeTrend: 150 }, // Recovery
                { price: 0.750, volume: 1500, momentum: -60, volumeTrend: 400 }, // Second hunt
                { price: 1.100, volume: 2000, momentum: 70, volumeTrend: 600 }, // Strong reversal
                { price: 1.400, volume: 2500, momentum: 85, volumeTrend: 800 }, // Momentum peak
                { price: 1.200, volume: 1500, momentum: -30, volumeTrend: 400 }, // Distribution
                { price: 1.500, volume: 3000, momentum: 90, volumeTrend: 1000 }, // Final push
                { price: 0.900, volume: 4000, momentum: -80, volumeTrend: 1200 } // Trap spring
            ]
        },
        {
            name: 'Momentum Cascade',
            patterns: [
                { price: 1.000, volume: 200, momentum: 40, volumeTrend: 100 }, // Strong start
                { price: 1.200, volume: 400, momentum: 60, volumeTrend: 200 }, // First leg
                { price: 1.500, volume: 800, momentum: 80, volumeTrend: 400 }, // Second leg
                { price: 1.800, volume: 1600, momentum: 90, volumeTrend: 800 }, // Peak momentum
                { price: 1.600, volume: 2000, momentum: -20, volumeTrend: 1000 }, // First crack
                { price: 1.400, volume: 2500, momentum: -40, volumeTrend: 1200 }, // Acceleration
                { price: 1.200, volume: 3000, momentum: -60, volumeTrend: 1400 }, // Cascade
                { price: 1.000, volume: 3500, momentum: -80, volumeTrend: 1600 }, // Panic
                { price: 0.800, volume: 4000, momentum: -90, volumeTrend: 1800 } // Capitulation
            ]
        },
        {
            name: 'Volume Climax Reversal',
            patterns: [
                { price: 1.000, volume: 100, momentum: 20, volumeTrend: 50 }, // Base
                { price: 1.200, volume: 200, momentum: 40, volumeTrend: 100 }, // First push
                { price: 1.400, volume: 400, momentum: 60, volumeTrend: 200 }, // Acceleration
                { price: 1.600, volume: 800, momentum: 80, volumeTrend: 400 }, // FOMO
                { price: 1.800, volume: 1600, momentum: 90, volumeTrend: 800 }, // Climax
                { price: 1.600, volume: 3200, momentum: -30, volumeTrend: 1600 }, // Volume spike
                { price: 1.400, volume: 2400, momentum: -50, volumeTrend: 1200 }, // Distribution
                { price: 1.200, volume: 1800, momentum: -70, volumeTrend: 900 }, // Continuation
                { price: 1.000, volume: 1200, momentum: -85, volumeTrend: 600 } // Final flush
            ]
        },
        {
        ...
        },
        {
            ...
            patterns: [
                { price: 1.00, volume: 100, momentum: 20, volumeTrend: 50 }, // Preliminary Support (PS)
                { price: 1.20, volume: 200, momentum: 40, volumeTrend: 100 }, // Buying Climax (BC)
                ...
                { price: 1.00, volume: 300, momentum: -40, volumeTrend: 150 }, // Spring
                { price: 1.10, volume: 200, momentum: 20, volumeTrend: 100 }, // Test
                { price: 1.30, volume: 400, momentum: 50, volumeTrend: 200 }, // Sign of Strength (SOS)
                { price: 1.20, volume: 300, momentum: -20, volumeTrend: 150 }, // Backup
                { price: 1.50, volume: 500, momentum: 60, volumeTrend: 300 } // Markup
            ]
        },
        {
            name: 'Triple Top Distribution',
            patterns: [
                { price: 1.00, volume: 100, momentum: 30, volumeTrend: 50 }, // Initial Rally
                { price: 1.20, volume: 200, momentum: 50, volumeTrend: 100 }, // First Top
                { price: 1.10, volume: 150, momentum: -20, volumeTrend: 80 }, // First Pullback
                { price: 1.20, volume: 180, momentum: 40, volumeTrend: 90 }, // Second Top
                { price: 1.08, volume: 160, momentum: -30, volumeTrend: 70 }, // Second Pullback
                { price: 1.20, volume: 150, momentum: 35, volumeTrend: 60 }, // Third Top
                ...
                { price: 0.90, volume: 400, momentum: -60, volumeTrend: 200 } // Distribution Breakdown
            ]
        },
        {
            name: 'Institutional Absorption',
            patterns: [
                { price: 1.00, volume: 50, momentum: 10, volumeTrend: -50 }, // Low Volume Drift
                ...
                { price: 1.00, volume: 200, momentum: -15, volumeTrend: 100 }, // Test of Support
                { price: 1.10, volume: 500, momentum: 40, volumeTrend: 250 }, // Institutional Buying
                { price: 1.05, volume: 300, momentum: -20, volumeTrend: 150 }, // Shake Out
                { price: 1.20, volume: 600, momentum: 50, volumeTrend: 300 }, // Mark Up Phase
                { price: 1.15, volume: 400, momentum: -15, volumeTrend: 200 }, // Consolidation
                { price: 1.40, volume: 800, momentum: 70, volumeTrend: 400 } // Institutional Display
            ]
        },
        {
            name: 'Momentum Failure Pattern',
            patterns: [
                { price: 1.00, volume: 100, momentum: 20, volumeTrend: 50 }, // Base Building
                { price: 1.20, volume: 200, momentum: 40, volumeTrend: 100 }, // Initial Breakout
                { price: 1.40, volume: 300, momentum: 60, volumeTrend: 150 }, // Strong Momentum
                { price: 1.60, volume: 400, momentum: 80, volumeTrend: 200 }, // Peak Momentum
                ...
                { price: 1.50, volume: 400, momentum: -20, volumeTrend: 200 }, // Support Break
                { price: 1.55, volume: 200, momentum: 10, volumeTrend: -50 }, // Failed Rally
                { price: 1.30, volume: 500, momentum: -60, volumeTrend: 250 } // Momentum Collapse
            ]
        },
        {
            name: 'Smart Money Divergence',
            patterns: [
                { price: 1.00, volume: 100, momentum: 30, volumeTrend: -30 }, // Quiet Accumulation
                { price: 1.10, volume: 50, momentum: 40, volumeTrend: -50 }, // Low Volume Rise
                { price: 1.25, volume: 30, momentum: 50, volumeTrend: -70 }, // Retail FOMO
                { price: 1.40, volume: 20, momentum: 60, volumeTrend: -90 }, // Volume Divergence
                ...
                { price: 1.30, volume: 300, momentum: -40, volumeTrend: 150 }, // Heavy Distribution
                { price: 1.35, volume: 100, momentum: 10, volumeTrend: -60 }, // Final Bull Trap
                { price: 1.00, volume: 400, momentum: -70, volumeTrend: 200 } // Smart Money Exit
            ]
        },
        {
            name: 'Liquidity Hunt Complex',
            patterns: [
                { price: 1.00, volume: 200, momentum: -40, volumeTrend: 100 }, // Stop Hunt Low
                { price: 1.15, volume: 300, momentum: 30, volumeTrend: 150 }, // Relief Rally
                { price: 1.10, volume: 250, momentum: -20, volumeTrend: 120 }, // First Consolidation
                { price: 1.25, volume: 400, momentum: 50, volumeTrend: 200 }, // Breakout
                { price: 1.20, volume: 350, momentum: -30, volumeTrend: 170 }, // High Test
                { price: 1.30, volume: 450, momentum: 40, volumeTrend: 220 }, // New High
                { price: 1.15, volume: 500, momentum: -50, volumeTrend: 250 }, // Stop Hunt High
                { price: 1.20, volume: 300, momentum: 20, volumeTrend: 150 }, // Failed Recovery
                { price: 0.90, volume: 600, momentum: -80, volumeTrend: 300 } // Liquidity Cascade
            ]
        },
        {
            name: 'Institutional Iceberg',
            patterns: [
                { price: 1.00, volume: 50, momentum: 10, volumeTrend: -80 }, // Quiet Accumulation
                { price: 1.05, volume: 30, momentum: 20, volumeTrend: -90 }, // Stealth Buying
                { price: 1.10, volume: 20, momentum: 30, volumeTrend: -95 }, // Continued Accumulation
                ...
                { price: 1.20, volume: 600, momentum: -40, volumeTrend: 300 }, // Final Iceberg
                { price: 1.40, volume: 1000, momentum: 80, volumeTrend: 500 } // Full Display
            ]
        },
        {
            name: 'Algorithmic Stop Hunt',
            patterns: [
                { price: 1.00, volume: 200, momentum: -30, volumeTrend: 100 }, // Initial Drop
                { price: 0.95, volume: 300, momentum: -50, volumeTrend: 150 }, // Stop Trigger
                { price: 0.90, volume: 400, momentum: -70, volumeTrend: 200 }, // Cascade
                ...
                { price: 1.20, volume: 300, momentum: -20, volumeTrend: 150 } // Consolidation
            ]
        },
        {
            name: 'Volatility Compression',
            patterns: [
                { price: 1.00, volume: 100, momentum: 10, volumeTrend: -50 }, // Base Building
                ...
                { price: 1.20, volume: 500, momentum: 70, volumeTrend: 300 }, // Explosive Breakout
                { price: 1.15, volume: 400, momentum: -20, volumeTrend: 200 }, // First Pullback
                { price: 1.30, volume: 600, momentum: 60, volumeTrend: 400 }, // Continuation
        ...
        },
        {
            ...
            patterns: [
                { price: 1.00, volume: 300, momentum: -40, volumeTrend: 150 }, // Selling Climax
                { price: 0.90, volume: 400, momentum: -60, volumeTrend: 200 }, // Automatic Rally
                { price: 0.85, volume: 500, momentum: -80, volumeTrend: 250 }, // Secondary Test
                { price: 0.95, volume: 200, momentum: 20, volumeTrend: -50 }, // Spring
                { price: 0.90, volume: 100, momentum: -20, volumeTrend: -70 }, // Test
                { price: 1.10, volume: 600, momentum: 60, volumeTrend: 300 }, // Sign of Strength
                { price: 1.05, volume: 400, momentum: -30, volumeTrend: 200 }, // Backup
                { price: 1.20, volume: 700, momentum: 70, volumeTrend: 350 }, // First Markup
                { price: 1.40, volume: 1000, momentum: 90, volumeTrend: 500 } // Second Markup
            ]
        },
        {
            name: 'Engineered Short Squeeze',
            patterns: [
                { price: 1.00, volume: 200, momentum: -20, volumeTrend: 100 }, // Initial Weakness
                { price: 0.95, volume: 300, momentum: -40, volumeTrend: 150 }, // Short Build-up
                { price: 0.90, volume: 400, momentum: -60, volumeTrend: 200 }, // Maximum Pain
                { price: 1.00, volume: 500, momentum: 20, volumeTrend: 250 }, // First Cover
                { price: 1.10, volume: 600, momentum: 40, volumeTrend: 300 }, // Momentum Shift
                { price: 1.25, volume: 700, momentum: 60, volumeTrend: 350 }, // Squeeze Start
                { price: 1.50, volume: 800, momentum: 80, volumeTrend: 400 }, // Peak Squeeze
                { price: 1.40, volume: 600, momentum: -20, volumeTrend: 300 }, // Profit Taking
                { price: 1.30, volume: 400, momentum: -40, volumeTrend: 200 } // Stabilization
            ]
        },
        {
            name: 'Dark Pool Distribution',
            patterns: [
                { price: 1.00, volume: 50, momentum: 20, volumeTrend: -80 }, // Quiet Accumulation
                { price: 1.10, volume: 40, momentum: 30, volumeTrend: -90 }, // Stealth Distribution
                { price: 1.20, volume: 30, momentum: 40, volumeTrend: -95 }, // Continued Distribution
                { price: 1.30, volume: 20, momentum: 50, volumeTrend: -97 }, // Peak Distribution
                ...
                { price: 1.20, volume: 500, momentum: -40, volumeTrend: 250 }, // Heavy Distribution
                { price: 1.25, volume: 600, momentum: 20, volumeTrend: 300 }, // Final Bull Trap
                { price: 1.00, volume: 1000, momentum: -70, volumeTrend: 500 } // Collapse
            ]
        },
        {
            name: 'Iceberg Absorption',
            patterns: [
                { price: 1.00, volume: 100, momentum: 20, volumeTrend: -80 }, // Hidden accumulation
                { price: 0.95, volume: 50, momentum: -10, volumeTrend: -90 }, // Price suppression
                { price: 1.10, volume: 200, momentum: 30, volumeTrend: 100 }, // Visible buy
                { price: 1.05, volume: 50, momentum: -15, volumeTrend: -85 }, // Absorption
                { price: 1.20, volume: 300, momentum: 40, volumeTrend: 150 }, // Break up
                { price: 1.50, volume: 500, momentum: 60, volumeTrend: 250 } // Markup
            ]
        },
        {
            name: 'Composite Man Game',
            patterns: [
                { price: 1.00, volume: 100, momentum: 15, volumeTrend: 50 }, // Initial interest
                { price: 1.20, volume: 200, momentum: 35, volumeTrend: 100 }, // Public participation
                { price: 1.10, volume: 300, momentum: -20, volumeTrend: 150 }, // Shakeout
                { price: 1.30, volume: 400, momentum: 45, volumeTrend: 200 }, // Mark up
                { price: 1.20, volume: 500, momentum: -25, volumeTrend: 250 }, // Secondary test
                { price: 1.50, volume: 600, momentum: 55, volumeTrend: 300 } // Final markup
            ]
        },
        {
            name: 'Smart Money Reversal',
            patterns: [
                { price: 1.00, volume: 200, momentum: -30, volumeTrend: 100 }, // Selling climax
                { price: 0.90, volume: 300, momentum: -45, volumeTrend: 150 }, // Automatic rally
                { price: 0.85, volume: 400, momentum: -60, volumeTrend: 200 }, // Secondary test
                { price: 1.00, volume: 500, momentum: 20, volumeTrend: 250 }, // Spring
                { price: 1.20, volume: 600, momentum: 40, volumeTrend: 300 }, // Sign of strength
                { price: 1.50, volume: 700, momentum: 60, volumeTrend: 350 } // Markup
            ]
        },
        {
            name: 'Institutional Distribution',
            patterns: [
                { price: 1.00, volume: 100, momentum: 40, volumeTrend: -70 }, // Stealth distribution
                { price: 1.20, volume: 200, momentum: 60, volumeTrend: -60 }, // Public participation
                ...
                { price: 0.90, volume: 600, momentum: -60, volumeTrend: 300 } // Markdown
            ]
        },
        {
            ...
            patterns: [
                { price: 1.00, volume: 200, momentum: -20, volumeTrend: 100 }, // Initial weakness
                { price: 0.90, volume: 300, momentum: -40, volumeTrend: 150 }, // Stop sweep low
                { price: 1.10, volume: 400, momentum: 30, volumeTrend: 200 }, // Sharp reversal
                { price: 1.30, volume: 500, momentum: 50, volumeTrend: 250 }, // Momentum chase
                { price: 1.50, volume: 600, momentum: 70, volumeTrend: 300 }, // FOMO peak
                { price: 1.20, volume: 700, momentum: -30, volumeTrend: 350 } // Distribution
            ]
        },
        {
            name: 'Dark Pool Accumulation',
            patterns: [
                { price: 1.00, volume: 50, momentum: -10, volumeTrend: -90 }, // Hidden buying
                { price: 0.95, volume: 40, momentum: -20, volumeTrend: -95 }, // Price suppression
                { price: 0.90, volume: 30, momentum: -30, volumeTrend: -97 }, // Final test
                { price: 1.10, volume: 300, momentum: 40, volumeTrend: 150 }, // Visible breakout
                { price: 1.30, volume: 400, momentum: 60, volumeTrend: 200 }, // Public chase
                { price: 1.50, volume: 500, momentum: 80, volumeTrend: 250 } // Mark up
            ]
        },
        {
            name: 'Volatility Expansion Trap',
            patterns: [
                { price: 1.00, volume: 100, momentum: 20, volumeTrend: -50 }, // Low volatility base
                { price: 1.20, volume: 200, momentum: 40, volumeTrend: 100 }, // Initial breakout
                { price: 1.40, volume: 300, momentum: 60, volumeTrend: 150 }, // Momentum chase
                { price: 1.20, volume: 400, momentum: -30, volumeTrend: 200 }, // Sharp reversal
                { price: 1.30, volume: 500, momentum: 20, volumeTrend: 250 }, // Dead cat bounce
                { price: 1.00, volume: 600, momentum: -50, volumeTrend: 300 } // Trap completion
            ]
        },
        {
            name: 'Institutional Range Game',
            patterns: [
                { price: 1.00, volume: 200, momentum: 30, volumeTrend: -60 }, // Range establishment
                { price: 1.15, volume: 300, momentum: 45, volumeTrend: 100 }, // Upper test
                { price: 0.90, volume: 400, momentum: -35, volumeTrend: 150 }, // Lower sweep
                { price: 1.10, volume: 500, momentum: 25, volumeTrend: -70 }, // Accumulation
                { price: 1.30, volume: 600, momentum: 55, volumeTrend: 200 }, // Range break
                { price: 1.50, volume: 700, momentum: 75, volumeTrend: 250 } // Trend start
            ]
        },
        {
            name: 'Smart Money Divergence',
            patterns: [
                { price: 1.00, volume: 300, momentum: 50, volumeTrend: 150 }, // Initial strength
                { price: 1.20, volume: 200, momentum: 60, volumeTrend: 100 }, // New high
                { price: 1.30, volume: 100, momentum: 70, volumeTrend: 50 }, // Volume divergence
                ...
                { price: 1.10, volume: 500, momentum: -40, volumeTrend: 250 } // Distribution
            ]
        },
        {
    ...
    for (const scenario of scenarios) {
        ...
        const simulator = new tradeSimulator_1.TradeSimulator(priceFeed, 1000);
