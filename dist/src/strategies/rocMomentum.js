...
export async function analyzeMomentum(priceHistory, currentPrice, config = {}) {
...
export function calculatePositionSize(analysis, maxPosition, availableBalance) {
...
export function calculateStopLoss(currentPrice, analysis) {
