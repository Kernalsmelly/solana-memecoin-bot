...
function mockSimulate(params, n) {
...
describe('ParameterSweepManager.runSweepFromEnv', () => {
    it('selects the best param combo by netPnL', async () => {
        ...
        const { bestParams, bestStats, allResults } = await ParameterSweepManager.runSweepFromEnv(3, mockSimulate);
...
//# sourceMappingURL=parameterSweep.test.js.map