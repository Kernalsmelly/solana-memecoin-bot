...
import { Position, TradingSignal, TradeOrder } from './types.js';
import { LiveOrderExecution } from './orderExecution.js';
import { Keypair } from '@solana/web3.js';
import { ContractValidator, createContractValidator } from './contractValidator.js';
...
import type { Strategy } from './strategy/StrategyCoordinator.js';
...
export class TradingSystem {
  ...
  constructor(connection: Connection) {
    ...
    const squeeze: Strategy = new VolatilitySqueeze({
