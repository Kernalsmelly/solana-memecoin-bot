...
export async function saveOpenPositions(positions: any[], maxRetries = 3) {
  ensureDataDir();
...
export async function loadOpenPositions(): Promise<any[]> {
  ensureDataDir();
