...
// import { getTokenMetadata } from '../utils/metadata'; // Commented out - Path/Function unknown
import { LIQUIDITY_STATE_LAYOUT_V4 } from '@raydium-io/raydium-sdk'; // Import Raydium SDK layout
...
async function fetchPoolDetailsFromRaydium(connection: Connection, poolAddress: string): Promise<RaydiumPoolDetails | null> {
    try {
        ...
        const poolState = LIQUIDITY_STATE_LAYOUT_V4.decode(accountInfo.data) as any; // Use any temporarily for debugging keys
